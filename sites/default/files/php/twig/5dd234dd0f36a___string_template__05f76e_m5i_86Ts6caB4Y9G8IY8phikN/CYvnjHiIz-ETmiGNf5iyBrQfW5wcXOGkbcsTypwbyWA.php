...
class __TwigTemplate_74148f62d8ef1eacd187de1575aed186439704198e1e960538c1bbb9e230a2b3 extends \Twig\Template
{
...
";
    ...
    {
        return new Source("{# inline_template_start #}<img src=\"{{ field_header_image }}\" id=\"title-header\">
<img src=\"{{ field_header_image_mobile }}\" id=\"title-header-mobile\">
<h1>
{{ field_header_main_heading }}<br>
{% if field_header_sub_heading|render is not empty %}
<span class=\"yellow\">{{ field_header_sub_heading }}</span>
{% endif%}
</h1>", "__string_template__05f76e29d493ac4df92da23db5b0d8b9116fb95d89868ef6744500fe5aea5460", "");
    }
}
