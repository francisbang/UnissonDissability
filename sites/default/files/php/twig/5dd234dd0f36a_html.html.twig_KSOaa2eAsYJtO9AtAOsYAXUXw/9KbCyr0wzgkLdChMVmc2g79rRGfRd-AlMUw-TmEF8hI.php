        ...
        echo "
            <div class=\"tools\">
                <div class=\"accessibility-bar\">
                    <div class=\"btn-accessibility\">Accessibility</div>
                    <div class=\"options accessibility-list\" style=\"display:none;\">
                        ";
        // line 90
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["page"] ?? null), "header_tools_left", [])), "html", null, true);
        echo "\t
                    </div>
                </div>
              ";
